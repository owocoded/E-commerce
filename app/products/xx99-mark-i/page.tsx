...
const XX99MarkIPage = () => {
  ...
  // Features
  const features = [
    "Dynamic 50mm drivers deliver accurate audio reproduction across the entire frequency range",
    "Precision-machined aluminum construction for durability and acoustic integrity",
    "Over-ear, closed-back design for maximum sound isolation and deep bass response",
    "Memory foam ear cushions and padded headband for comfort during extended listening sessions",
    "Premium braided cable with 3.5mm termination for superior signal transmission"
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 pt-8">
        <Link href="/headphones" className="text-gray-500 text-sm uppercase tracking-widest hover:text-orange-500 transition-colors">
          Go back
        </Link>
      </div>
            ...
            <div className="md:w-1/2">
              ...
              <div className="prose max-w-none">
                <p className="text-gray-500 mb-4">
                  The XX99 Mark I headphones feature a closed-back, circumaural design that provides excellent sound isolation and deep bass response. The precision-machined aluminum construction ensures durability and acoustic integrity.
                </p>
                <p className="text-gray-500">
                  Each component is carefully selected to deliver accurate audio reproduction across the entire frequency range. The dynamic 50mm drivers are coupled with a powerful neodymium magnet system for maximum efficiency and dynamic range.
                </p>
              </div>
            </div>
            <div className="md:w-1/2">
